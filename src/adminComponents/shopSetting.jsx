      ...
      <Container fluid={true}>
        ...
        <Row style={{ paddingTop: "10px" }}>
          ...
          <Col className="dashboard-panel" lg="6">
            ...
            <Segment>
              <Header as="h3">Delivery <Icon name='time' /></Header>
              ...
              <Header as="h3">Delivery Price <Icon name='money' /></Header>
              <Form onSubmit={this.onSubmit} size="tiny">
              <Form.Field width={5}>
              ...
              <Divider section />
              <Header as="h3">Minimum Order <Icon name='minus' /></Header>
              <Form onSubmit={this.onSubmit} size="tiny">
              ...
              <Divider section />
              <Header as="h3">Discount <Icon name='tag' /></Header>
              <Form onSubmit={this.onSubmit} size="tiny">
              <Form.Group>
                  <Form.Field width={5}>
              ...
              <Divider section />
              <Header as="h3">Public Notice  <Icon name='announcement' /></Header>
              <Form onSubmit={this.onSubmit} size="tiny">
                <Form.TextArea maxlength="300"
                  name="notice"  onChange={this.onChange} value={notice}
